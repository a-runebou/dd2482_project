...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_calendar_sources_user_id"),
        "calendar_sources",
        ["user_id"],
        unique=False,
    )
    op.create_table(
        ...
        sa.CheckConstraint(
            "mod(window_end_minute, 30) = 0", name="ck_groups_window_end_alignment"
        ),
        sa.CheckConstraint(
            "mod(window_start_minute, 30) = 0", name="ck_groups_window_start_alignment"
        ),
        ...
        sa.CheckConstraint(
            "window_start_minute < window_end_minute", name="ck_groups_window_order"
        ),
        sa.CheckConstraint(
    ...
    op.create_index(
        op.f("ix_magic_links_user_id"), "magic_links", ["user_id"], unique=False
    )
    op.create_table(
        "refresh_tokens",
        sa.Column("id", sa.UUID(), nullable=False),
    ...
    op.create_table(
        ...
        sa.CheckConstraint(
            "end_at > start_at", name="ck_busy_blocks_positive_duration"
        ),
        sa.ForeignKeyConstraint(
            ["source_id"], ["calendar_sources.id"], ondelete="CASCADE"
        ),
        sa.ForeignKeyConstraint(["user_id"], ["users.id"], ondelete="CASCADE"),
        sa.PrimaryKeyConstraint("id"),
    )
    op.create_index(
        op.f("ix_busy_blocks_source_id"), "busy_blocks", ["source_id"], unique=False
    )
    op.create_index(
        op.f("ix_busy_blocks_user_id"), "busy_blocks", ["user_id"], unique=False
    )
    op.create_table(
        "memberships",
        sa.Column("group_id", sa.UUID(), nullable=False),
    ...
    op.create_index(
        op.f("ix_proposals_group_id"), "proposals", ["group_id"], unique=False
    )
    op.create_index(
